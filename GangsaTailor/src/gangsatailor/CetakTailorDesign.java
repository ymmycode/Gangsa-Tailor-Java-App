 ...
 * @author achma
 */
public class CetakTailorDesign extends javax.swing.JInternalFrame {
    ...
    {
        try{
            sql = "select tailor.nopesan, tailor.tanggal, tailor.nama, paytailor.pembayaran, tailor.stat  from tailor,paytailor where stat IS NOT NULL AND tailor.nopesan = paytailor.idPesanan";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        BuktiTailor frm = new BuktiTailor(id);
        getParent().add(frm);
        frm.setVisible(true);
