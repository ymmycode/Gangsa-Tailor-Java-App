 ...
 * @author achma
 */
public class ReportTotalPendapatanTailor extends javax.swing.JInternalFrame {
    ...
    ResultSet rs;
    String sql,nowMonth;
    public ReportTotalPendapatanTailor(String month) {
        try {
            initComponents();
            initComponents();
            ...
            Logger.getLogger(ReportTotalPendapatanTailor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void Process() throws FileNotFoundException
    {
        try{
            ...
            InputStream filePath = getClass().getResourceAsStream("/Report/TotalPendapatanTailor.jrxml");
            JasperDesign jd1 = JRXmlLoader.load (filePath);
            
            
            sql = "select SUM(paytailor.pembayaran) \n" +
