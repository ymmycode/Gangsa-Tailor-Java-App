 ...
 * @author achma
 */
public class PaymentCustomerStat extends javax.swing.JInternalFrame {
    ...
    {
        try{
            sql = "select customer.nopesan, customer.tanggal, customer.nama, paycustomer.pembayaran  from customer,paycustomer where stat = 'DP' AND customer.nopesan = paycustomer.idPesanan";
    ...
    {
        try{
            sql = "select customer.nopesan, customer.tanggal, customer.nama, paycustomer.pembayaran  from customer,paycustomer where stat = 'Full' AND customer.nopesan = paycustomer.idPesanan";
    ...
    void UpdateStat() throws SQLException {
        ...
        {
            sql1 = "update customer set stat = 'Full' where nopesan = '"+id+"'";
