 ...
 * @author achma
 */
public class TailorDesign extends javax.swing.JInternalFrame {

    /**
     * Creates new form TailorDesign
     */
    ...
    void GetLastRow()
    {
        sql = "select nopesan from tailor ORDER BY nopesan DESC LIMIT 1"; 
            try{
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 255), 2), "Tailor Design", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Gill Sans MT", 0, 24))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        total = Integer.toString(tailorPrice * quantity);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {    
            ...
            Logger.getLogger(TailorDesign.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    void ProcessInput() throws SQLException {
        ...
        else
        {
            ...
            sql1 = "INSERT INTO tailor(tanggal, nama, jenis, ukuran, kuantitas) VALUES ('"
                    +tanggal+"','"
                    +nama+"','"
                    +jenis+"','"
                    +ukuran+"','"
            ...
            sql2 = "insert into paytailor(idPesanan, pembayaran) values ('"+idPesanan+"','"+pembayaran+"')";
