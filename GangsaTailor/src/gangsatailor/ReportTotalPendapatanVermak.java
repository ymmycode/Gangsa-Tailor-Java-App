 ...
 * @author achma
 */
public class ReportTotalPendapatanVermak extends javax.swing.JInternalFrame {
    ...
    public ReportTotalPendapatanVermak(String month) {
        try {
            initComponents();
            ...
            Logger.getLogger(ReportTotalPendapatanVermak.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void Process() throws FileNotFoundException
    {
        try{
            ...
            sql = "select SUM(payvermak.pembayaran) \n" +
