 ...
 * @author achma
 */
public class CetakVermak extends javax.swing.JInternalFrame {
    ...
    {
        try{
            sql = "select vermak.nopesan, vermak.tanggal, vermak.nama, payvermak.pembayaran, vermak.stat  from vermak,payvermak where stat IS NOT NULL AND vermak.nopesan = payvermak.idPesanan";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        BuktiVermak frm = new BuktiVermak(id);
        getParent().add(frm);
        frm.setVisible(true);
